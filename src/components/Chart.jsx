 ...
 const Chart = () => {
   return (
     <div className=' '>
      ...
      <div className='lg:w-3/5 sm:w-full md:w-full max-sm:w-full shadow-md bg-white'><ChartGraph/></div>
        <span className='lg:w-2/5  shadow-md sm:w-full md:w-full max-sm:w-full bg-white' ><Bar/></span>
        </div>
