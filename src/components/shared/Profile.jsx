    ...
    <div className="mx-auto max-w-screen-2xl p-4 md:p-6 h-screen  ">
      <div className="mx-8 max-w-270">
        <div className="flex flex-col  ">
          <h1 className=" text-2xl font-bold text-gray-800   flex ">Profile</h1>
        </div>
            ...
            <div className="p-10 ">
              <form>
                  ...
                  <div className="w-full  block mt-2  mb-2">
                    ...
                    <div className="border border-slate-200 p-6">
                      <div className="mb-4 flex items-center gap-3">
                        ...
                        ></div>
                        <div>
                          <span className="mb-1.5 font-medium text-gray-600  ">
                            Edit your photo
                          </span>
                ...
                <div className="flex justify-end gap-4 mt-5">
                  ...
                  <button
                    className=" ml-2 flex justify-center rounded bg-blue-800 text-white px-6 py-2 font-medium text-gray hover:bg-opacity-90"
                    type="submit"
                  >
                    Save
                  </button>
