  ...
  return (
    <div className=" bg-[#1C2434] pt-3  overflow-y-hidden  overscroll-none">
      <div class="flex flex-col bg-[#1C2434]  h-screen   overflow-y-hidden  justify-center items-center  ">
        <h1 class=" block text-center ml-4 mt-3  font-semibold">
          <img src={logo} className="left-6  text-center pt-2 " />
        </h1>
        <div class="p-6 m-6 shadow-lg bg-white rounded-md  sm:w-92 lg:w-1/2  ">
          ...
          <div class="mt-3">
            <label
              ...
              class="block text-base mb-2 text-slate-800"
            >
              Username
            </label>
            <input
              ...
              class="w-full border  rounded-lg border-stroke bg-transparent py-4 pl-6 pr-10 outline-blue-800"
            />
          </div>
          <div class="mt-3 ">
            <label for="password" class="block text-base text-slate-800  mb-2">
              Password{" "}
            </label>
            ...
            <input
              ...
              class="w-full border border-stroke  rounded-lg  bg-transparent py-4 pl-6 pr-10 outline-blue-800"
            />
          </div>
          ...
          <div class="mt-8 flex justify-between items-center">
            <div class="w-full text-center rounded-lg border border-stroke bg-blue-800 hover:bg-opacity-90 py-4 pl-6 pr-10 outline-blue-800 ">
              <button
                type="submit"
                class="w-full  text-slate-50 text-md font-medium "
          ...
          <div class="mt-6 text-center">
            <p class="font-medium">
              ...
              <a href="" class="text-blue-800 mx-2">
                Sign Up
              </a>
            </p>
          </div>
